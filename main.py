...
def afterTurnMenu(currentPlayer, playerList, monopolies):
...
def main():
    ...
    while True:
        ...
        startTurn = input(f"{currentPlayer.name}, press any key to roll")

        take_turn(currentPlayer, boardSpaces, playerList)

        while True:
            turnAction = afterTurnMenu(currentPlayer, playerList, monopolies)
            if turnAction == "":
